...
const BelowBannerComponent = () => {
    ...
    return (
        <div className='w-[90%] mx-auto'>
            ...
            <div
                className='mt-[30px] text-[#ffffff80] text-[20px] font-[600] flex items-center gap-[20px]'>

                {
                    allFiltersArray.map((filterName, index) => {
                        return (
                            <p
                                key={index}
                                className={`${filterName === activeFilter && 'text-white'} transition-all duration-500 cursor-pointer`}
